...
CREATE VIEW KARP.Ресурсы_на_планетах as
  SELECT п.имя, б.название_ресурса FROM KARP.Планеты п
      inner join KARP.Месторождения_ресурсов м on п.ид_планеты = м.ид_планеты
...
CREATE VIEW KARP.Отношение_государств as
  SELECT г1.название_государства, г2.название_государства, п.отношения
